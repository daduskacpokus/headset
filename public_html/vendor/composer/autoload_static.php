...
class ComposerStaticInited4aaad9b94e8f5de2b78582ff3179e6
{
    ...
    public static $classMap = array (
        ...
        'adapter' => __DIR__ . '/../..' . '/src/controllers/adapter.php',
        'barcode' => __DIR__ . '/../..' . '/lib/barcode.php',
        'codeprint' => __DIR__ . '/../..' . '/src/models/codeprint.php',
        'controller_cookie' => __DIR__ . '/../..' . '/src/controllers/cookie.php',
        'database_handler' => __DIR__ . '/../..' . '/src/controllers/database_handler.php',
        'iterable' => __DIR__ . '/../..' . '/src/controllers/iterable.php',
        'matches_cell' => __DIR__ . '/../..' . '/src/models/search/matches_cell.php',
        'model_matches_cortege' => __DIR__ . '/../..' . '/src/models/search/matches_cortege.php',
        'model_matches_tab' => __DIR__ . '/../..' . '/src/models/search/matches_tab.php',
        'rotate' => __DIR__ . '/../..' . '/src/models/rotate.php',
        'search' => __DIR__ . '/../..' . '/src/models/search/search.php',
        'selfprint' => __DIR__ . '/../..' . '/src/selfprint.php',
        'stat' => __DIR__ . '/../..' . '/src/models/stat.php',
        'statTest' => __DIR__ . '/../..' . '/tests/src/models/statTest.php',
        'supply' => __DIR__ . '/../..' . '/src/models/supply.php',
        'unbreakable' => __DIR__ . '/../..' . '/src/controllers/unbreakable.php',
        'vcodeprint' => __DIR__ . '/../..' . '/src/views/vcodeprint.php',
        'vrotate' => __DIR__ . '/../..' . '/src/views/vrotate.php',
        'vrotateTest' => __DIR__ . '/../..' . '/tests/src/views/vrotateTest.php',
        'vsearch' => __DIR__ . '/../..' . '/src/views/vsearch.php',
        'vsettings' => __DIR__ . '/../..' . '/src/views/vsettings.php',
        'vstat' => __DIR__ . '/../..' . '/src/views/vstat.php',
        'vsupply' => __DIR__ . '/../..' . '/src/views/vsupply.php',
        'vwriteoff' => __DIR__ . '/../..' . '/src/views/vwriteoff.php',
        'writeoff' => __DIR__ . '/../..' . '/src/models/writeoff.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInited4aaad9b94e8f5de2b78582ff3179e6::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInited4aaad9b94e8f5de2b78582ff3179e6::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInited4aaad9b94e8f5de2b78582ff3179e6::$prefixesPsr0;
            $loader->classMap = ComposerStaticInited4aaad9b94e8f5de2b78582ff3179e6::$classMap;
