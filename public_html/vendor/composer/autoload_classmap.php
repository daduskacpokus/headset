...
return array(
    ...
    'adapter' => $baseDir . '/src/controllers/adapter.php',
    'barcode' => $baseDir . '/lib/barcode.php',
    'codeprint' => $baseDir . '/src/models/codeprint.php',
    'controller_cookie' => $baseDir . '/src/controllers/cookie.php',
    'database_handler' => $baseDir . '/src/controllers/database_handler.php',
    'iterable' => $baseDir . '/src/controllers/iterable.php',
    'matches_cell' => $baseDir . '/src/models/search/matches_cell.php',
    'model_matches_cortege' => $baseDir . '/src/models/search/matches_cortege.php',
    'model_matches_tab' => $baseDir . '/src/models/search/matches_tab.php',
    'rotate' => $baseDir . '/src/models/rotate.php',
    'search' => $baseDir . '/src/models/search/search.php',
    'selfprint' => $baseDir . '/src/selfprint.php',
    'stat' => $baseDir . '/src/models/stat.php',
    'statTest' => $baseDir . '/tests/src/models/statTest.php',
    'supply' => $baseDir . '/src/models/supply.php',
    'unbreakable' => $baseDir . '/src/controllers/unbreakable.php',
    'vcodeprint' => $baseDir . '/src/views/vcodeprint.php',
    'vrotate' => $baseDir . '/src/views/vrotate.php',
    'vrotateTest' => $baseDir . '/tests/src/views/vrotateTest.php',
    'vsearch' => $baseDir . '/src/views/vsearch.php',
    'vsettings' => $baseDir . '/src/views/vsettings.php',
    'vstat' => $baseDir . '/src/views/vstat.php',
    'vsupply' => $baseDir . '/src/views/vsupply.php',
    'vwriteoff' => $baseDir . '/src/views/vwriteoff.php',
    'writeoff' => $baseDir . '/src/models/writeoff.php',
);
